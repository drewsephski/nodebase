/**
 * LangGraph Integration for Nodebase
 *
 ...
 * Converts Nodebase workflows to LangGraph StateGraph
 */
export class LangGraphExecutor {
  private workflow: Workflow;
  private graph: any; // Compiled StateGraph
  private apiKeys?: { anthropic?: string; groq?: string; openai?: string; openrouter?: string; firecrawl?: string; arcade?: string };
  ...
  constructor(
    ...
    apiKeys?: { anthropic?: string; groq?: string; openai?: string; openrouter?: string; firecrawl?: string; arcade?: string }
  ) {
